...
window.AI18N = {
  en: {
    ...
    "a.today.sendTitle": "Send today's WhatsApp reports", "a.today.sendDesc": "Emails have been sent. Tap each parent to send their WhatsApp report (it opens with the message ready — just press Send).",
  ...
  te: {
    ...
    "a.today.sendTitle": "ఈ రోజు వాట్సాప్ నివేదికలు పంపండి", "a.today.sendDesc": "ఇమెయిల్‌లు పంపబడ్డాయి. ప్రతి తల్లిదండ్రుల వాట్సాప్ నివేదిక పంపడానికి వారిని నొక్కండి (సందేశం సిద్ధంగా తెరుచుకుంటుంది — పంపండి నొక్కితే చాలు).",
